...
CONFIG_FREERTOS_MINIMUM_STACK_SIZE=2048
...
#
CONFIG_MAIXPY_GC_HEAP_SIZE=0x100000
...
# CONFIG_MAIXPY_TOUCH_SCREEN_DRIVER_NS2009 is not set
CONFIG_MAIXPY_OMV_MINIMUM=y
CONFIG_MAIXPY_OMV_CONV_YUV_FAST=y
CONFIG_MAIXPY_OMV_DOUBLE_BUFF=y
# Sensor type (OV5642)
CONFIG_OMV_SENSOR_OV5642=y

# Default camera resolution (adjust based on your needs)
CONFIG_OMV_DEFAULT_RESOLUTION=QVGA  # Options: QQVGA, QVGA, VGA, etc.

# Frame buffer size (critical for stability)
CONFIG_OMV_FB_SIZE=0x40000  # 256KB (adjust if you get memory errors)
